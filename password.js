...
function passwordGenerator(input,  capitalLetters, nums, mix){
    const password = []
...
function generate(){
    ...
    console.log(inputValue, upper, num, mixed)

    const password = passwordGenerator(inputValue, upper, num, mixed);
    console.log(password)
